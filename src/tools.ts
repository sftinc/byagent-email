...
const MESSAGE_SUMMARY = {
  ...
  properties: {
    ...
    from: CONTACT,
    recipients: { type: "array", items: CONTACT },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        unread: { type: "boolean" },
        from: { type: "string", description: "Part of the sender's address or name, case-insensitive" },
        to: { type: "string", description: "Part of a recipient's address or name" },
